...
This command delegates detailed audit to the **wiz-reviewer** agent (`wiz-reviewer`), which provides comprehensive milestone audit output suitable for quality assurance activities.
