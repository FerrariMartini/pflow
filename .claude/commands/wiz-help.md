---
description: Lists the available wiz commands and explains the planning workflow
...
generate_help_text() {
    ...
    echo "   • Check command documentation: .claude/commands/$command_name.md"
    echo "   • View workflow guide: .claude/NOTICE.md"
    echo "   • Run /wiz-status to check project state"
    echo ""
    
    # Footer
    echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    echo "  For complete documentation, see: .claude/NOTICE.md"
    echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    echo ""
...
show_quick_help() {
    ...
    echo "   /wiz-retro <slug> <n>          Retrospect a closed phase (debt/guideline/ADR)"
    echo ""
    echo "📚 Documentation:"
    echo "   .claude/NOTICE.md             Overview and usage guide"
    echo "   .claude/NOTICE.md          Migration notes"
    echo ""
    echo "💡 Tips:"
...
if [[ -z "$COMMAND_NAME" ]]; then
    ...
    if [[ ! -f "$COMMAND_FILE" ]]; then
        echo "❌ Error: Command not found: $COMMAND_NAME"
        echo ""
        list_available_commands ".claude/commands"
        exit 1
    fi
...
- `.claude/NOTICE.md` - Overview and usage guide
- `.claude/NOTICE.md` - Migration notes
- Individual command files in `.claude/commands/` directory
