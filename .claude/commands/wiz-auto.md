...
- `wiz-go-specialist` for Go
- `wiz-typescript-specialist` for TypeScript
- `wiz-python-specialist` for Python
- `wiz-csharp-specialist` for C#
- `wiz-java-specialist` for Java
- `wiz-docker-specialist` for Docker
...
- For Go: `wiz-go-specialist`
- For TypeScript: `wiz-typescript-specialist`
- For Python: `wiz-python-specialist`
- For C#: `wiz-csharp-specialist`
- For Java: `wiz-java-specialist`
- For Docker: `wiz-docker-specialist`
...
Now delegate to the **milestone-analyst** agent by referencing `wiz-milestone-analyst`:

**Agent Reference**: `wiz-milestone-analyst`
