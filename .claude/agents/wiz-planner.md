---
name: wiz-planner
description: Strategic planning agent: decomposes a PRD into implementation phases and detailed milestones with acceptance criteria. Use for /wiz-phases and /wiz-milestones.
---
