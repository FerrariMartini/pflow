---
name: wiz-milestone-analyst
description: Gatekeeper that determines whether the next milestone can be started, based on dependencies and current project state.
---
